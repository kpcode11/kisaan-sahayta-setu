...
import { MapPin, Clock, Phone, Navigation, Star, Filter } from "lucide-react";
...
const HelpCentersSection = () => {
  ...
  return (
    <section id="help-centers-section" className="py-20 bg-muted/30">
...
export default HelpCentersSection;